...
export interface ComplexityAnalysisReport {
  ...
  dimensionTrends: Record<
    keyof ComplexityScore['dimensions'],
    {
      average: number;
...
export class QueryComplexityAnalyzer {
  ...
  private userComplexityProfiles: Map<
    string,
    {
   ...
   */
  public generateComplexityReport(timeRange?: {
    from: number;
    to: number;
  ...
  private identifyComplexityFactors(query: string, parsedQuery: ParsedQuery): ComplexityFactor[] {
  ...
  private filterHistoryByTimeRange(timeRange?: { from: number; to: number }): ComplexityMetrics[] {
  ...
  private calculateDimensionTrends(metrics: ComplexityMetrics[]): Record<
    keyof ComplexityScore['dimensions'],
    {
      average: number;
      trend: 'increasing' | 'decreasing' | 'stable';
