...
class ImportExportService {
    ...
    async exportToJSON(options = {}) {
        try {
            ...
            throw new services_1.ServiceError(`JSON export failed: ${error.message}`, 'EXPORT_FAILED', 500, { options, originalError: error });
        }
    }
    ...
    async exportToCSV(options = {}) {
        try {
            ...
            throw new services_1.ServiceError(`CSV export failed: ${error.message}`, 'EXPORT_FAILED', 500, { options, originalError: error });
        }
    }
    ...
    async exportToXML(options = {}) {
        try {
            ...
            throw new services_1.ServiceError(`XML export failed: ${error.message}`, 'EXPORT_FAILED', 500, { options, originalError: error });
        }
    }
    ...
    async backup(backupPath) {
        try {
            ...
            throw new services_1.ServiceError(`Backup failed: ${error.message}`, 'BACKUP_FAILED', 500, { backupPath, originalError: error });
        }
    }
    ...
    async findExistingEntry(entry) {
        try {
            ...
            const exactMatch = results.find(result => result.entry.title.toLowerCase() === entry.title.toLowerCase());
