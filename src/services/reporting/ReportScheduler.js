...
class ReportScheduler extends events_1.EventEmitter {
    ...
    checkIntervalMs;
    isRunning = false;
    constructor(logger, reportGenerator, dataExporter, checkIntervalMs = 60000, maxHistoryPerReport = 100) {
        super();
        this.logger = logger;
    ...
    createScheduledReport(reportConfig, schedule, notificationSettings, createdBy, exportConfig, name, description) {
