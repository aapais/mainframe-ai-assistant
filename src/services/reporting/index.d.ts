...
export declare class ReportingSystem extends EventEmitter {
    ...
    generateQuickReport(name: string, dataSource: string, fields: string[], format?: 'json' | 'csv' | 'excel'): Promise<import("./ReportGenerator").ReportResult>;
    quickExport(data: any[], format: 'csv' | 'json' | 'excel', fileName?: string): Promise<string>;
    createQuickAlert(name: string, dataSource: string, metric: string, threshold: number, comparison?: 'gt' | 'lt' | 'eq', notificationEmails?: string[]): import("./AlertManager").AlertRule;
}
export declare function createReportingSystem(logger: Logger, config?: ReportingSystemConfig): ReportingSystem;
