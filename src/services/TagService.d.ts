...
import { Tag, CreateTag, UpdateTag, TagAssociation, BulkTagOperation, BulkOperationResult, TagAnalytics } from '../database/schemas/HierarchicalCategories.schema';
...
export declare class TagService extends EventEmitter {
    ...
    associateTagWithEntry(entryId: string, tagId: string, options?: TagAssociationOptions, userId?: string): Promise<void>;
    ...
    replaceEntryTags(entryId: string, tagIds: string[], options?: TagAssociationOptions, userId?: string): Promise<void>;
    getTagSuggestions(query: string, options?: {
        limit?: number;
        categoryId?: string;
        contextEntryId?: string;
    }): Promise<Tag[]>;
    getOrCreateTag(name: string, options?: {
        displayName?: string;
        categoryId?: string;
        color?: string;
        description?: string;
    ...
    getTrendingTags(days?: number, limit?: number): Promise<(Tag & {
        recent_usage: number;
    })[]>;
    getTagStats(): Promise<{
        totalTags: number;
