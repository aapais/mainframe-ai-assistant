...
exports.CategoryImportExportService =
  exports.CategoryTemplateSchema =
  exports.ImportResultSchema =
  exports.ExportOptionsSchema =
  exports.ImportOptionsSchema =
    void 0;
  ...
  filterCategoriesForExport(categories, options) {
    ...
    if (options.rootCategoryId) {
      filtered = filtered.filter(
        cat =>
          cat.node.id === options.rootCategoryId || this.isDescendantOf(cat, options.rootCategoryId)
      );
    }
