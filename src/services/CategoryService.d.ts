...
import { CategoryNode, CategoryTree, CreateCategory, UpdateCategory, BulkCategoryOperation, BulkOperationResult, CategoryAnalytics } from '../database/schemas/HierarchicalCategories.schema';
...
export declare class CategoryService extends EventEmitter {
    ...
    private config;
    constructor(categoryRepository: CategoryRepository, cacheService?: CacheService, config?: CategoryServiceConfig);
    ...
    getCategoryChildren(parentId: string | null, options?: CategoryQueryOptions): Promise<CategoryNode[]>;
    ...
    moveCategory(categoryId: string, newParentId: string | null, userId?: string): Promise<CategoryNode>;
