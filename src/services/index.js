...
exports.ServiceUtils = exports.resetGlobalServiceFactory = exports.setGlobalServiceFactory = exports.getGlobalServiceFactory = exports.ServiceFactory = exports.ExportImportServiceFactory = exports.EnhancedValidationService = exports.DataTransformer = exports.FormatConverter = exports.ImportService = exports.ExportService = exports.ImportExportService = exports.MetricsService = exports.CacheService = exports.SearchService = exports.ValidationService = exports.KnowledgeBaseService = void 0;
...
var KnowledgeBaseService_1 = require("./KnowledgeBaseService");
Object.defineProperty(exports, "KnowledgeBaseService", { enumerable: true, get: function () { return tslib_1.__importDefault(KnowledgeBaseService_1).default; } });
var ValidationService_1 = require("./ValidationService");
Object.defineProperty(exports, "ValidationService", { enumerable: true, get: function () { return tslib_1.__importDefault(ValidationService_1).default; } });
var SearchService_1 = require("./SearchService");
Object.defineProperty(exports, "SearchService", { enumerable: true, get: function () { return tslib_1.__importDefault(SearchService_1).default; } });
var CacheService_1 = require("./CacheService");
Object.defineProperty(exports, "CacheService", { enumerable: true, get: function () { return tslib_1.__importDefault(CacheService_1).default; } });
var MetricsService_1 = require("./MetricsService");
Object.defineProperty(exports, "MetricsService", { enumerable: true, get: function () { return tslib_1.__importDefault(MetricsService_1).default; } });
var ImportExportService_1 = require("./ImportExportService");
Object.defineProperty(exports, "ImportExportService", { enumerable: true, get: function () { return tslib_1.__importDefault(ImportExportService_1).default; } });
var export_1 = require("./storage/export");
Object.defineProperty(exports, "ExportService", { enumerable: true, get: function () { return export_1.ExportService; } });
Object.defineProperty(exports, "ImportService", { enumerable: true, get: function () { return export_1.ImportService; } });
Object.defineProperty(exports, "FormatConverter", { enumerable: true, get: function () { return export_1.FormatConverter; } });
Object.defineProperty(exports, "DataTransformer", { enumerable: true, get: function () { return export_1.DataTransformer; } });
Object.defineProperty(exports, "EnhancedValidationService", { enumerable: true, get: function () { return export_1.ValidationService; } });
Object.defineProperty(exports, "ExportImportServiceFactory", { enumerable: true, get: function () { return export_1.ExportImportServiceFactory; } });
var ServiceFactory_1 = require("./ServiceFactory");
Object.defineProperty(exports, "ServiceFactory", { enumerable: true, get: function () { return tslib_1.__importDefault(ServiceFactory_1).default; } });
Object.defineProperty(exports, "getGlobalServiceFactory", { enumerable: true, get: function () { return ServiceFactory_1.getGlobalServiceFactory; } });
Object.defineProperty(exports, "setGlobalServiceFactory", { enumerable: true, get: function () { return ServiceFactory_1.setGlobalServiceFactory; } });
Object.defineProperty(exports, "resetGlobalServiceFactory", { enumerable: true, get: function () { return ServiceFactory_1.resetGlobalServiceFactory; } });
...
async function createMinimalKBService(dbPath) {
    const { KnowledgeBaseService, ValidationService, SearchService } = await Promise.resolve().then(() => tslib_1.__importStar(require('./')));
    const config = {
        database: {
