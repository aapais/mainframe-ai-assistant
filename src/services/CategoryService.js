...
class CategoryService extends events_1.EventEmitter {
  ...
  async createCategory(data, userId) {
    try {
      const validatedData =
        HierarchicalCategories_schema_1.HierarchicalSchemaValidator.validateCreateCategory(data);
  ...
  async updateCategory(id, updates, userId) {
    try {
      ...
      const validatedUpdates =
        HierarchicalCategories_schema_1.HierarchicalSchemaValidator.validateUpdateCategory(updates);
  ...
  async bulkOperation(operation, userId) {
    try {
      const validatedOperation =
        HierarchicalCategories_schema_1.HierarchicalSchemaValidator.validateBulkCategoryOperation(
          operation
        );
  ...
  async validateHierarchyIntegrity() {
    try {
      ...
      const flatCategories = this.flattenHierarchy(allCategories);
      const validation =
        HierarchicalCategories_schema_1.HierarchicalSchemaValidator.validateCategoryHierarchy(
          flatCategories
        );
