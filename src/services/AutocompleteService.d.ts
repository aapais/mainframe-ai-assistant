...
import { AutocompleteSuggestion, AutocompleteQuery } from '../database/schemas/HierarchicalCategories.schema';
...
export declare class AutocompleteService extends EventEmitter {
    ...
    getSuggestions(query: AutocompleteQuery, context?: SearchContext): Promise<AutocompleteSuggestion[]>;
    recordSelection(query: string, selectedSuggestion: AutocompleteSuggestion, context?: SearchContext): Promise<void>;
