...
export declare class QueryCache {
    ...
    private queryStats;
    private config;
    constructor(cacheOrchestrator: CacheOrchestrator, config?: {
        maxCacheSize: number;
        defaultTTL: number;
        maxQueryTime: number;
        enableStats: boolean;
    });
    executeSearchQuery<T>(query: string, filters: any | undefined, executor: QueryExecutor<T>, ttl?: number): Promise<T>;
    executeDbQuery<T>(sql: string, params: any[] | undefined, executor: QueryExecutor<T>, ttl?: number): Promise<T>;
    executeApiCall<T>(endpoint: string, method: string, params: any | undefined, executor: QueryExecutor<T>, ttl?: number): Promise<T>;
