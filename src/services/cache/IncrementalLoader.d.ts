...
export declare class IncrementalLoader<T = any> extends EventEmitter {
    ...
    load<U extends T>(request: LoadRequest<U>, dataSource: (offset: number, limit: number) => Promise<U[]>): Promise<U[]>;
    preload<U extends T>(requestId: string, query: string, chunkIds: string[], dataSource: (chunkId: string) => Promise<U[]>): Promise<number>;
