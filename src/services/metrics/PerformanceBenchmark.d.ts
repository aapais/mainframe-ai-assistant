...
export declare class PerformanceBenchmark {
    ...
    static createDatabaseBenchmark(queryFn: () => Promise<any>, queryName?: string): BenchmarkOperation;
    static createCacheBenchmark(cacheGet: (key: string) => Promise<any>, keyPrefix?: string): BenchmarkOperation;
