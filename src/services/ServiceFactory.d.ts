import { IKnowledgeBaseService, IValidationService, ISearchService, ICacheService, IMetricsService, IImportExportService, ServiceConfig } from '../types/services';
...
export declare class ServiceFactory {
    ...
    registerCustomService<T extends keyof ServiceInstances>(serviceName: T, serviceInstance: ServiceInstances[T]): void;
