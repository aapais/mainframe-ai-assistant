...
export type { MVPMigrationConfig, MigrationExecutionOptions, MigrationProgress } from './MigrationService';
export { MigrationPlanner } from './MigrationPlanner';
export type { MigrationPlan, MigrationPhase, ValidationCheck, MVPMigrationPath } from './MigrationPlanner';
export { SchemaEvolution } from './SchemaEvolution';
export type { SchemaVersion, SchemaChange, CompatibilityInfo, SchemaEvolutionPlan, SchemaSnapshot, SchemaRiskAssessment } from './SchemaEvolution';
export { DataTransformer } from './DataTransformer';
export type { DataTransformation, TransformationPlan, TransformationResult, MVPDataMigration } from './DataTransformer';
export { RollbackManager } from './RollbackManager';
export type { RollbackPlan, RollbackStep, RollbackResult, EmergencyRollbackPlan, RollbackCheckpoint } from './RollbackManager';
export { ValidationService } from './ValidationService';
export type { ValidationResult, ValidationError, ValidationWarning, ComprehensiveValidationReport, SchemaValidationResult, DataIntegrityResult, ReferentialIntegrityResult, ValidationSummary } from './ValidationService';
...
export declare function createMigrationFramework(config: MigrationFrameworkConfig): MigrationFramework;
