...
exports.BackupStrategy = exports.DifferentialBackupStrategy = exports.IncrementalBackupStrategy = exports.FullBackupStrategy = exports.AbstractBackupStrategy = void 0;
...
class IncrementalBackupStrategy extends AbstractBackupStrategy {
    ...
    async tableHasTimestamp(adapter, tableName) {
        try {
            ...
            return schema.some(col => col.name === 'updated_at' ||
                col.name === 'created_at' ||
                col.name === 'timestamp');
        }
        catch {
