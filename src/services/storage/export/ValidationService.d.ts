...
export declare class ValidationService {
    ...
    validateRecord(record: any, index: number, options?: ValidationOptions): Promise<{
        valid: boolean;
        issues: ValidationIssue[];
    }>;
    validateBatch(batch: any[], batchIndex?: number, options?: ValidationOptions): Promise<ValidationResult>;
