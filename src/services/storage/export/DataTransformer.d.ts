...
export declare class DataTransformer {
    ...
    transformWithPipeline(data: any[], pipelineId: string, context?: TransformContext): Promise<any[]>;
    transformBatch(batch: any[], options: TransformOptions | ImportTransformOptions, batchIndex?: number): Promise<any[]>;
    ...
    validateTransformation(sampleData: any[], options: TransformOptions | ImportTransformOptions): {
        compatible: boolean;
