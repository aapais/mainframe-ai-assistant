...
class ExportService extends events_1.EventEmitter {
    ...
    async export(format, outputPath, options = {}, progressCallback) {
        ...
        try {
            ...
            const result = await this.performExport(format, transformedData, outputPath, options, (progress) => {
            ...
            async read() {
                ...
                try {
                    ...
                    const transformedBatch = options.transform
                        ...
                        : batch.data;
                    const convertedData = await this.formatConverter.convert(transformedBatch, format, { streaming: true });
