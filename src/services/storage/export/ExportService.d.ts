...
import { IExportService, ExportOptions, ExportResult, ExportFormat, ExportMetadata, ProgressCallback, IKnowledgeBaseService } from '../../../types/services';
...
export declare class ExportService extends EventEmitter implements IExportService {
    ...
    exportBatch(jobs: Array<{
        format: ExportFormat;
        outputPath: string;
        options?: ExportOptions;
    }>, progressCallback?: (completedJobs: number, totalJobs: number) => void): Promise<ExportResult[]>;
    exportForSystem(targetSystem: 'servicenow' | 'jira' | 'confluence' | 'sharepoint' | 'generic', outputPath: string, options?: ExportOptions): Promise<ExportResult>;
