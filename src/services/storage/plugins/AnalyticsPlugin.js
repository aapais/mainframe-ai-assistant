...
class AnalyticsPlugin extends BaseStoragePlugin_1.BaseStoragePlugin {
  ...
  async generateIncidentTrendsReport(parameters) {
    ...
    return {
      ...
      summary: {
        ...
        avg_mttr:
          mttrStats.reduce((sum, row) => sum + row.avg_resolution_time, 0) /
  ...
  async generatePerformanceReport(parameters) {
    ...
    return {
      ...
      summary: {
        avg_search_time:
          searchPerformance.reduce((sum, row) => sum + row.avg_response_time, 0) /
  ...
  async generateCodeQualityReport(parameters) {
    ...
    return {
      ...
      summary: {
        ...
        avg_complexity:
          qualityMetrics.reduce((sum, row) => sum + (row.avg_complexity || 0), 0) /
  ...
  async generateTemplateUsageReport(parameters) {
    ...
    return {
      ...
      summary: {
        ...
        avg_success_rate:
          templateStats.reduce((sum, row) => sum + (row.avg_success_rate || 0), 0) /
