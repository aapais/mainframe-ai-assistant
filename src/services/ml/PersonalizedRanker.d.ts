...
export declare class PersonalizedRanker {
    ...
    rankResults(results: SearchResult[], query: string, personalizationFeatures?: PersonalizationFeatures): Promise<SearchResult[]>;
    ...
    updateUserInteraction(userId: string, resultId: string, query: string, action: 'click' | 'view' | 'skip', metadata?: Record<string, any>): Promise<void>;
