...
import { IKnowledgeBaseService, IValidationService, ISearchService, ICacheService, IMetricsService, IImportExportService, ServiceConfig, KBEntry, KBEntryInput, KBEntryUpdate, SearchResult, SearchOptions, ListOptions, PaginatedResult, KBMetrics, ExportOptions, ImportOptions, ImportResult, RestoreResult } from '../types/services';
export declare class KnowledgeBaseService extends EventEmitter implements IKnowledgeBaseService {
    ...
    private startTime;
    private statements;
    constructor(config?: ServiceConfig, validationService?: IValidationService | undefined, searchService?: ISearchService | undefined, cacheService?: ICacheService | undefined, metricsService?: IMetricsService | undefined, importExportService?: IImportExportService | undefined);
