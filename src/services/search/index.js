...
exports.OPTIMIZATION_LEVELS =
  ...
  exports.FTS5Integration =
  exports.FTS5Engine =
  exports.SearchBenchmark =
  exports.SearchCache =
  exports.RankingEngine =
  exports.FuzzyMatcher =
  exports.QueryParser =
  exports.TextProcessor =
  exports.InvertedIndex =
  exports.AdvancedSearchEngine =
    void 0;
...
Object.defineProperty(exports, 'AdvancedSearchEngine', {
  enumerable: true,
  get() {
    return tslib_1.__importDefault(AdvancedSearchEngine_1).default;
  },
});
const InvertedIndex_1 = require('./InvertedIndex');
Object.defineProperty(exports, 'InvertedIndex', {
  enumerable: true,
  get() {
    return tslib_1.__importDefault(InvertedIndex_1).default;
  },
});
const TextProcessor_1 = require('./TextProcessor');
Object.defineProperty(exports, 'TextProcessor', {
  enumerable: true,
  get() {
    return tslib_1.__importDefault(TextProcessor_1).default;
  },
});
...
Object.defineProperty(exports, 'QueryParser', {
  enumerable: true,
  get() {
    return tslib_1.__importDefault(QueryParser_1).default;
  },
});
const FuzzyMatcher_1 = require('./FuzzyMatcher');
Object.defineProperty(exports, 'FuzzyMatcher', {
  enumerable: true,
  get() {
    return tslib_1.__importDefault(FuzzyMatcher_1).default;
  },
});
const RankingEngine_1 = require('./RankingEngine');
Object.defineProperty(exports, 'RankingEngine', {
  enumerable: true,
  get() {
    return tslib_1.__importDefault(RankingEngine_1).default;
  },
});
const SearchCache_1 = require('./SearchCache');
Object.defineProperty(exports, 'SearchCache', {
  enumerable: true,
  get() {
    return tslib_1.__importDefault(SearchCache_1).default;
  },
});
const SearchBenchmark_1 = require('./SearchBenchmark');
Object.defineProperty(exports, 'SearchBenchmark', {
  enumerable: true,
  get() {
    return tslib_1.__importDefault(SearchBenchmark_1).default;
  },
});
const FTS5Engine_1 = require('./FTS5Engine');
Object.defineProperty(exports, 'FTS5Engine', {
  enumerable: true,
  get() {
    return tslib_1.__importDefault(FTS5Engine_1).default;
  },
});
const FTS5Integration_1 = require('./FTS5Integration');
Object.defineProperty(exports, 'FTS5Integration', {
  enumerable: true,
  get() {
    return tslib_1.__importDefault(FTS5Integration_1).default;
  },
});
