...
export declare class RankingEngine {
    ...
    private stats;
    constructor();
    rankDocuments(query: ParsedQuery, postingLists: Map<string, PostingList>, collection: DocumentCollection, options?: Partial<RankingOptions>): RankingScore[];
    calculateBM25(queryTerms: QueryTerm[], docId: string, doc: IndexedDocument, postingLists: Map<string, PostingList>, collection: DocumentCollection, params?: BM25Parameters): number;
    calculateTFIDF(queryTerms: QueryTerm[], docId: string, doc: IndexedDocument, postingLists: Map<string, PostingList>, collection: DocumentCollection, params?: TFIDFParameters): number;
