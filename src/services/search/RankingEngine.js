...
class RankingEngine {
    ...
    calculateBM25(queryTerms, docId, doc, postingLists, collection, params = this.defaultOptions.bm25) {
        let score = 0;
    ...
    calculateTFIDF(queryTerms, docId, doc, postingLists, collection, params = this.defaultOptions.tfidf) {
        let score = 0;
    ...
    explainScore(score) {
        ...
        for (const component of score.components) {
            ...
            explanations.push(`- ${component.factor}: ${component.value.toFixed(3)} × ${component.weight.toFixed(2)} = ${contribution}% (${component.explanation})`);
        }
        if (score.boosted) {
