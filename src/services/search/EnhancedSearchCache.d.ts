...
export declare class EnhancedSearchCache {
    ...
    get<T = SearchResult[]>(key: string, options?: SearchOptions, userContext?: string): Promise<T | null>;
    set<T = SearchResult[]>(key: string, value: T, options?: SearchOptions, computationTime?: number, userContext?: string): Promise<void>;
