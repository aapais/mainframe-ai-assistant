...
export type WebSocketMessageType = 'search_update' | 'kb_entry_created' | 'kb_entry_updated' | 'kb_entry_deleted' | 'search_results_invalidated' | 'user_search_activity' | 'system_notification' | 'heartbeat' | 'error';
...
export declare class SearchWebSocketService extends EventEmitter {
    ...
    disconnect(): void;
    sendMessage(type: WebSocketMessageType, payload: any, options?: {
        requireAck?: boolean;
        priority?: 'low' | 'medium' | 'high';
    }): Promise<any>;
