...
export declare class BatchOperationsService extends EventEmitter {
    ...
    batchUpdate(entryIds: string[], updates: Partial<KBEntry> | ((entry: KBEntry) => Partial<KBEntry>), options?: BatchOperationOptions): Promise<BatchOperationResult<KBEntry>>;
    batchDelete(entryIds: string[], options?: BatchOperationOptions): Promise<BatchOperationResult<void>>;
    batchDuplicate(entryIds: string[], options?: BatchOperationOptions): Promise<BatchOperationResult<KBEntry>>;
    batchExport(entryIds: string[], format?: 'json' | 'csv' | 'markdown' | 'xml', options?: BatchOperationOptions): Promise<BatchOperationResult<string>>;
    batchImport(data: string, format?: 'json' | 'csv' | 'xml', options?: BatchOperationOptions & {
