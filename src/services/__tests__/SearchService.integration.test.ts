...
describe('SearchService Integration Tests', () => {
  ...
  async function createTestEntries(): Promise<KBEntry[]> {
    const entries = [
      ...
      },
      {
        ...
        problem:
          'Program abends with S0C7 data exception during arithmetic operations or MOVE statements.',
        solution:
  ...
  describe('AI Service Integration Tests', () => {
    ...
    test('should handle AI timeout gracefully', async () => {
      ...
      const results = await serviceWithTimeout.search('complex query', testEntries, {
        useAI: true,
      });
