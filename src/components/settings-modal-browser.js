...
window.SettingsModal = function({ isOpen, onClose, userId }) {
    ...
    return React.createElement('div', {
        className: 'fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 settings-modal'
    }, [
        React.createElement('div', {
            key: 'modal-content',
            className: 'bg-white dark:bg-gray-900 rounded-xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden fade-in'
        }, [
            // Header
            React.createElement('div', {
                key: 'header',
...
window.ThemeTab = function({ settings, updateSetting }) {
    ...
    return React.createElement('div', { className: 'space-y-6' }, [
        React.createElement('div', { key: 'theme-selector', className: 'grid grid-cols-3 gap-4' },
            themes.map(theme =>
                React.createElement('button', {
                    key: theme.id,
        ...
        React.createElement('div', { key: 'animations', className: 'flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-800 rounded-lg' }, [
...
window.DisplayTab = function({ settings, updateSetting }) {
    return React.createElement('div', { className: 'space-y-6' }, [
        ...
        React.createElement('div', { key: 'font-size', className: 'space-y-2' }, [
            React.createElement('label', { className: 'font-medium' }, `Font Size: ${settings.font_size}px`),
            React.createElement('input', {
                type: 'range',
                min: 10,
                max: 24,
...
window.DataTab = function({ settings, updateSetting }) {
    return React.createElement('div', { className: 'space-y-6' }, [
        ...
        // Auto Save
        React.createElement('div', { key: 'autosave', className: 'flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-800 rounded-lg' }, [
