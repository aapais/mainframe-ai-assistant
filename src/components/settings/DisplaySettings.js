...
const DisplaySettings = ({ settings, onUpdate, onMarkChanged }) => {
  ...
  const previewText =
    'Sample text to demonstrate the current display settings. This includes code blocks and various UI elements.';
          ...
          React.createElement(
            'div',
            {
              ...
              style: {
                ...
                padding:
                  densityOptions.find(d => d.id === displayDensity)?.preview.padding || '4px',
                lineHeight:
                  densityOptions.find(d => d.id === displayDensity)?.preview.lineHeight || '1.5',
              },
            },
            [
              React.createElement(
