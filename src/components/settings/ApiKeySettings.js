            ...
            supportedServices.map(service => {
              ...
              return React.createElement(
                'div',
                {
                  key: service.id,
                  className:
                    'bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded-lg p-4',
                },
                [
                  // Service Header
                  React.createElement(
                      ...
                      hasKey &&
                        React.createElement(
                          'span',
                          {
                            ...
                            className:
                              'px-2 py-1 bg-green-100 dark:bg-green-900 text-green-700 dark:text-green-300 rounded text-xs font-medium',
                          },
                          'Configured'
                        ),
                    ]
                            ...
                            React.createElement(
                              ...
                              [
                                React.createElement('input', {
                                  ...
                                  className:
                                    'flex-1 px-3 py-2 border border-gray-300 dark:border-gray-600 rounded bg-white dark:bg-gray-700 text-gray-900 dark:text-white',
                                ...
                                React.createElement(
                                  'button',
                                  {
                                    ...
                                    className:
                                      'px-3 py-2 bg-gray-500 text-white rounded hover:bg-gray-600',
                                  },
                                  '×'
                                ),
                              ]
                              ...
                              [
                                React.createElement(
                                  'div',
                                  {
                                    key: 'key-display',
                                    className:
                                      'flex-1 px-3 py-2 bg-gray-100 dark:bg-gray-700 rounded font-mono text-sm',
                                  },
                                  hasKey
                                    ? showKeys[service.id]
                                      ? apiKeys[service.id]
                                      : maskKey(apiKeys[service.id])
                                ...
                                React.createElement(
                                  'button',
                                  {
                                    ...
                                    className:
                                      'p-2 text-blue-500 hover:text-blue-700 dark:hover:text-blue-300',
                                  },
                                  '✏️'
                                ),
                                ...
                                hasKey &&
                                  React.createElement(
                                    'button',
                                    {
                                      ...
                                      className:
                                        'p-2 text-red-500 hover:text-red-700 dark:hover:text-red-300',
                                    },
                                    '🗑️'
                                  ),
                              ]
                            ...
                            React.createElement(
                              'button',
                              {
                                ...
                                className: `px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 disabled:bg-gray-400 disabled:cursor-not-allowed text-sm ${
                                  testing && testResults[service.id] === 'testing'
                                    ? 'animate-pulse'
                                    : ''
                                }`,
                              },
