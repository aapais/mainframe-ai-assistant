        ...
        React.createElement('div', {
            ...
            React.createElement('div', {
                ...
                React.createElement('div', {
                    ...
                    React.createElement('div', {
                        ...
                        React.createElement('div', {
                            ...
                            React.createElement('div', {
                                ...
                                style: { backgroundColor: theme.preview.text, opacity: 0.8, width: '60%' }
                            }),
                            React.createElement('div', {
                                key: 'line2',
                                className: 'h-2 rounded',
                                style: { backgroundColor: theme.preview.text, opacity: 0.5, width: '80%' }
                            }),
                            React.createElement('div', {
                                key: 'accent',
                                className: 'h-2 rounded',
                    ...
                    // Selection indicator
                    currentTheme === theme.id && React.createElement('div', {
                        key: 'selected',
                    ...
                    React.createElement('button', {
                        key: 'preview-btn',
                        className: 'absolute bottom-2 right-2 text-xs px-2 py-1 bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 rounded',
                        onClick: (e) => {
                            e.stopPropagation();
            ...
            previewTheme && React.createElement('div', {
                key: 'preview-notification',
                className: 'bg-yellow-50 dark:bg-yellow-900 border border-yellow-200 dark:border-yellow-700 rounded-lg p-3'
            }, [
                React.createElement('p', {
                    key: 'preview-text',
