    ...
    try {
      ...
      if (notifications.sound) {
        ...
        const audio = new Audio(
          'data:audio/wav;base64,UklGRnoGAABXQVZFZm10IBAAAAABAAEAQB8AAEAfAAABAAgAZGF0YQoGAACBhYqFbF1fdJivrJBhNjVgodDbq2EcBj+a2/LDciUFLIHO8tiJNwgZaLvt559NEAxQp+PwtmMcBjiR1/LMeSwFJHfH8N2QQAoUXrTp66hVFApGn+DyvmwhBDuU2O'
        );
        audio.volume = 0.3;
  ...
  const getPermissionStatusText = () => {
    switch (permissionStatus) {
      case 'granted':
        return 'Granted';
      case 'denied':
        return 'Denied - Please enable in browser settings';
      default:
            ...
            deliverySettings.map(notification =>
              React.createElement(
                'div',
                {
                  ...
                  className:
                    'flex items-center justify-between p-4 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-600',
                },
                [
                  React.createElement(
                    'div',
