...
const AuthenticationStatus = ({ isAuthenticated, user, lastLogin, sessionExpiry }) => {
  return React.createElement('div', {
    ...
    isAuthenticated && user && React.createElement('div', {
      key: 'user-details',
  ...
  return React.createElement('div', {
    ...
    React.createElement('div', {
      ...
      React.createElement('div', {
        ...
        provider.description && React.createElement('p', {
          key: 'description',
        ...
        showStatus && React.createElement('div', {
          ...
          provider.maintenanceMode && React.createElement('span', {
            key: 'maintenance',
...
describe('SSO UI Snapshot Tests', () => {
  ...
  describe('Dark Mode Variations', () => {
    it('should match snapshot for dark mode login buttons', () => {
      ...
      const { container } = render(
        React.createElement(DarkModeWrapper, null,
          React.createElement(LoginButton, {
            provider,
            onClick: jest.fn(),
            loading: false,
