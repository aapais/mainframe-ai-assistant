...
const { LLMError, RateLimitError, ComplianceError } = require('../../../src/services/llm-integration/utils/LLMErrors');
...
describe('LLM Service Integration Tests', () => {
    ...
    describe('Compliance and Security', () => {
        test('should validate input in strict compliance mode', async () => {
            ...
            await expect(llmService.generateResponse(null))
                .rejects.toThrow(LLMError);
        });
        ...
        test('should anonymize sensitive data when enabled', async () => {
            ...
            // Mock sanitization
            const { sanitizeBankingData } = require('../../../src/services/llm-integration/utils/InputValidator');
        ...
        test('should throw compliance error when features are disabled', async () => {
            ...
            await expect(llmService.analyzeFraudRisk({}))
    ...
    describe('Rate Limiting', () => {
        test('should enforce rate limits', async () => {
            ...
            await expect(llmService.checkRateLimit('openai'))
        ...
        test('should handle rate limit errors from providers', async () => {
            ...
            await expect(llmService.callProvider('openai', 'test prompt'))
                .rejects.toThrow(RateLimitError);
        });
    });
    ...
    describe('RAG Integration', () => {
        test('should enhance prompts with RAG when enabled', async () => {
            ...
            // Mock RAG pipeline
            llmService.ragPipeline.retrieve = jest.fn().mockResolvedValue([
    ...
    describe('Error Handling', () => {
        test('should handle timeout errors', async () => {
            ...
            await expect(llmService.callProvider('openai', 'test prompt'))
                .rejects.toThrow('Timeout for openai');
        });
