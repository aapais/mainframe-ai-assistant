...
exports.DashboardUtils = exports.MonitoringDashboard = void 0;
...
class MonitoringDashboard extends events_1.EventEmitter {
    ...
    currentData = null;
    refreshTimer;
    constructor(searchMonitor, performanceMonitor, cacheMonitor) {
        super();
    ...
    buildResponseTimeChartWidget(trends) {
        return {
            ...
            data: {
                ...
                series: [
                    {
                        name: 'Average',
                        data: trends?.responseTime?.map((point) => ({
                            x: point.time,
                            y: point.avg
                        })) || [],
                        color: 'blue'
    ...
    buildCacheMetricsWidget(cacheMetrics) {
        return {
            id: 'cache_metrics',
    ...
    buildTopQueriesWidget(topQueries) {
        return {
            id: 'top_queries',
            title: 'Top Queries',
            type: 'table',
    ...
    buildSlowQueriesWidget(slowQueries) {
        return {
            id: 'slow_queries',
            title: 'Slow Queries',
            type: 'table',
    ...
    buildSystemHealthWidget(performanceStatus) {
        return {
            id: 'system_health',
            title: 'System Health',
            type: 'metric',
...
exports.DashboardUtils = {
    formatMetric: (value, format) => {
        switch (format) {
            case 'bytes':
                return exports.DashboardUtils.formatBytes(value);
            case '0.1f':
