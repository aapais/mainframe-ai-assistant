...
export function getPerformanceConfig(env: string = 'production'): PerformanceConfig {
  return performanceConfigs[env as keyof typeof performanceConfigs] || performanceConfigs.production;
}
...
export function getMonitoringThresholds(env: string = 'production') {
  return monitoringThresholds[env as keyof typeof monitoringThresholds] || monitoringThresholds.production;
}
