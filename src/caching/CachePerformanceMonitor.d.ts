...
export declare class CachePerformanceMonitor extends EventEmitter {
    ...
    private targets;
    private config;
    constructor(database: Database.Database, cacheManager: MultiLayerCacheManager, warmingEngine: CacheWarmingEngine, invalidationManager: CacheInvalidationManager, mvpLevel: 1 | 2 | 3 | 4 | 5);
