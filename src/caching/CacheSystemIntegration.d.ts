...
export declare class CacheSystemIntegration {
    ...
    searchKB(query: string, options?: {
        limit?: number;
        category?: string;
        userContext?: string;
        useAI?: boolean;
    }): Promise<any[]>;
    analyzePatterns(timeWindow?: string, options?: {
        userContext?: string;
        components?: string[];
    }): Promise<any[]>;
    analyzeCode(filePath: string, options?: {
        userContext?: string;
        analysisType?: 'syntax' | 'quality' | 'links';
    }): Promise<any>;
    warmCache(strategy?: 'popular' | 'user-specific' | 'time-based' | 'predictive', userContext?: string): Promise<number>;
...
export declare function createCacheSystem(database: Database.Database, config: CacheSystemConfig): Promise<CacheSystemIntegration>;
