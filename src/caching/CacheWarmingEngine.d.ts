...
export declare class CacheWarmingEngine extends EventEmitter {
    ...
    private stats;
    private config;
    constructor(database: Database.Database, cacheManager: MultiLayerCacheManager, mvpLevel: 1 | 2 | 3 | 4 | 5);
    ...
    learnFromInteraction(userId: string, query: string, category: string, responseTime: number, timestamp?: Date): Promise<void>;
