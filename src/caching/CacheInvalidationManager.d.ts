...
export declare class CacheInvalidationManager extends EventEmitter {
    ...
    onDataChange(table: string, operation: 'INSERT' | 'UPDATE' | 'DELETE', affectedIds?: string[], changes?: Record<string, any>): Promise<InvalidationEvent[]>;
    invalidate(pattern?: string, tags?: string[], cascade?: boolean, reason?: string): Promise<InvalidationEvent>;
    adjustTTL(cacheKey: string, accessPattern: {
        accessCount: number;
        lastAccessed: Date;
