...
export interface UsageMetrics {
    ...
    uniqueUsers: number;
    mostUsed: Array<KBEntry & {
        rank: number;
    }>;
    leastUsed: Array<KBEntry & {
        rank: number;
    }>;
...
export type UsageAction = 'view' | 'search' | 'rate_success' | 'rate_failure' | 'create' | 'update' | 'delete' | 'export' | 'share';
...
export declare class ServiceError extends Error {
    ...
    recoverable: boolean;
    constructor(message: string, code: string, statusCode?: number, details?: any | undefined, recoverable?: boolean);
    toJSON(): {
        name: string;
        message: string;
        code: string;
...
export interface ServiceEvents {
    ...
    'entries:batch-updated': (updates: Array<{
        id: string;
        entry: KBEntry;
