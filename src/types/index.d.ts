...
export type KBCategory = 'JCL' | 'VSAM' | 'DB2' | 'Batch' | 'Functional' | 'IMS' | 'CICS' | 'System' | 'Other';
...
export type AppErrorType = 'DATABASE_ERROR' | 'AI_SERVICE_ERROR' | 'NETWORK_ERROR' | 'VALIDATION_ERROR' | 'PERMISSION_ERROR' | 'UNKNOWN_ERROR';
