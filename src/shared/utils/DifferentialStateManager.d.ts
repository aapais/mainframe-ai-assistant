...
export declare class DifferentialStateManager extends EventEmitter {
    ...
    applyDifferentialUpdate<T>(stateKey: string, baseVersion: number, stateChange: StateChange<T>): Promise<T | null>;
    subscribe<T>(stateKey: string, callback: (change: StateChange<T>) => void, options?: Partial<StateSubscription['options']>): string;
