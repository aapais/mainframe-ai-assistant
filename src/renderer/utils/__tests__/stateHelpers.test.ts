...
describe('Performance Monitor', () => {
  ...
  it('should warn about slow operations', () => {
    ...
    mockPerformanceNow.mockReturnValueOnce(0).mockReturnValueOnce(2000); // 2 seconds

    monitor.endTime(monitor.startTime());

    expect(consoleSpy).toHaveBeenCalledWith('Slow operation detected in slow-operation: 2000.00ms');
