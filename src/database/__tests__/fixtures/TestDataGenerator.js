...
exports.DEFAULT_TEST_DATA_SIZE = exports.BULK_OPERATION_THRESHOLD = exports.SEARCH_PERFORMANCE_THRESHOLD = exports.TestDataGenerator = void 0;
    ...
    generateSearchQuery() {
        ...
        return {
            ...
            tags: this.faker.datatype.boolean({ probability: 0.4 })
                ? this.faker.helpers.arrayElements(['error', 'performance', 'timeout', 'memory', 'file'], this.faker.number.int({ min: 1, max: 3 }))
                : undefined,
