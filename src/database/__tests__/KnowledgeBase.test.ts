...
describe('Knowledge Base Repository', () => {
  ...
  describe('Basic CRUD Operations', () => {
    test('should create a new KB entry', async () => {
    ...
    test('should soft delete an entry', async () => {
      // Create entry first
      const newEntry: CreateKBEntry = {
    ...
    test('should get total count of entries', async () => {
  ...
  describe('Search Operations', () => {
    ...
    test('should search entries by query text', async () => {
    ...
    test('should search with facets', async () => {
      const searchQuery: SearchQuery = {
        query: 'error'
      };
  ...
  describe('Feedback and Usage Tracking', () => {
    test('should record entry feedback', async () => {
  ...
  describe('Bulk Operations', () => {
    test('should bulk create entries', async () => {
    ...
    test('should bulk delete entries', async () => {
