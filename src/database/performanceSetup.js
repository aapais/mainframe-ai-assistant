...
exports.SearchPerformanceBenchmark = exports.SearchOptimizationEngine = exports.AdvancedIndexStrategy = exports.QueryCache = exports.ConnectionPool = exports.KnowledgeDB = void 0;
...
async function setupPerformanceOptimizedDB(options = {}) {
    ...
    const { dbPath = './knowledge_optimized.db', maxConnections = 10, cacheSize = 1000, enableBenchmarking = true, customThresholds = {} } = options;
    try {
        ...
        const manager = await PerformanceManager_1.PerformanceManagerFactory.create(db, connectionPool, cache, {
            thresholds: {
                maxQueryTime: 1000,
                minCacheHitRate: 0.8,
...
async function validatePerformanceOptimizations(db, manager) {
    ...
    try {
        ...
        const searchPromises = Array.from({ length: 50 }, (_, i) => db.search(`test query ${i}`, { limit: 10 }));
