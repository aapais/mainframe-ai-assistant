...
exports.PerformanceSchemas = exports.PerformanceSchemaValidator = exports.BenchmarkResultSchema = exports.OptimizationRecommendationSchema = exports.PerformanceAlertSchema = exports.DatabasePerformanceSchema = exports.QueryExecutionPlanSchema = exports.IndexAnalysisSchema = exports.CacheStatsSchema = exports.CacheEntrySchema = exports.QueryPerformanceMetricsSchema = exports.SearchOptionsSchema = exports.SearchStrategySchema = void 0;
...
exports.SearchOptionsSchema = zod_1.z.object({
    ...
    sortBy: zod_1.z.enum(['relevance', 'usage', 'success_rate', 'created_at', 'updated_at']).default('relevance'),
...
exports.CacheStatsSchema = zod_1.z.object({
    ...
    topKeys: zod_1.z.array(zod_1.z.object({
        key: zod_1.z.string(),
...
exports.IndexAnalysisSchema = zod_1.z.object({
    ...
    queryPatterns: zod_1.z.array(zod_1.z.object({
