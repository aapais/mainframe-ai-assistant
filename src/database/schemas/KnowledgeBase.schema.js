...
exports.DatabaseSchemas = exports.SchemaValidator = exports.QueryPerformanceSchema = exports.DatabaseStatsSchema = exports.AuditLogSchema = exports.BackupLogSchema = exports.SystemConfigSchema = exports.SearchHistorySchema = exports.UsageMetricSchema = exports.EntryFeedbackSchema = exports.SearchWithFacetsSchema = exports.SearchQuerySchema = exports.SearchResultSchema = exports.UpdateKBEntrySchema = exports.CreateKBEntrySchema = exports.KBEntrySchema = exports.SearchMatchTypeSchema = exports.SeverityLevelSchema = exports.KBCategorySchema = void 0;
...
exports.SeverityLevelSchema = zod_1.z.enum([
    'critical',
    'high',
    'medium',
    'low'
...
exports.SearchQuerySchema = zod_1.z.object({
    ...
    sortBy: zod_1.z.enum(['relevance', 'usage', 'success_rate', 'created_at', 'updated_at'])
...
exports.SearchWithFacetsSchema = zod_1.z.object({
    ...
    facets: zod_1.z.object({
        ...
        severities: zod_1.z.array(zod_1.z.object({
            name: zod_1.z.string(),
            count: zod_1.z.number().int().min(0)
        }))
    }),
...
exports.DatabaseStatsSchema = zod_1.z.object({
    ...
    topEntries: zod_1.z.array(zod_1.z.object({
