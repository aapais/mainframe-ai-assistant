...
exports.HierarchicalSchemas = exports.HierarchicalSchemaValidator = exports.TagAnalyticsSchema = exports.CategoryAnalyticsSchema = exports.FacetedSearchQuerySchema = exports.SearchFacetSchema = exports.AutocompleteQuerySchema = exports.AutocompleteSuggestionSchema = exports.BulkOperationResultSchema = exports.BulkTagOperationSchema = exports.BulkCategoryOperationSchema = exports.TagAssociationSchema = exports.UpdateTagSchema = exports.CreateTagSchema = exports.TagSchema = exports.UpdateCategorySchema = exports.CreateCategorySchema = exports.CategoryTreeSchema = exports.CategoryNodeSchema = void 0;
...
exports.AutocompleteQuerySchema = zod_1.z.object({
    ...
    types: zod_1.z.array(zod_1.z.enum(['category', 'tag', 'entry', 'search_term'])).default(['category', 'tag']),
...
exports.CategoryAnalyticsSchema = zod_1.z.object({
    ...
    top_tags: zod_1.z.array(zod_1.z.object({
        tag_id: zod_1.z.string().uuid(),
...
exports.TagAnalyticsSchema = zod_1.z.object({
    ...
    co_occurrence: zod_1.z.array(zod_1.z.object({
        tag_id: zod_1.z.string().uuid(),
        tag_name: zod_1.z.string(),
        count: zod_1.z.number().int().min(0),
