...
Object.defineProperty(exports, 'MetricsCollector', {
  enumerable: true,
  get() {
    return MetricsCollector_1.MetricsCollector;
  },
});
...
class MonitoringSystem extends events_1.EventEmitter {
  ...
  initializeComponents() {
    this.performanceMonitor = new PerformanceMonitor_2.PerformanceMonitor(
      this.db,
    ...
    this.dashboardProvider = new DashboardProvider_2.DashboardProvider(
      this.db,
