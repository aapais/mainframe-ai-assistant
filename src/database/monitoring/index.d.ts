...
export declare class MonitoringSystem extends EventEmitter {
    ...
    measureQuery<T>(operation: string, query: string, connectionId: string, executor: () => Promise<T> | T, options?: {
        userId?: string;
    ...
    implementIndexRecommendation(recommendationId: string, execute?: boolean): Promise<{
        success: boolean;
        error?: string;
        sql?: string;
    }>;
...
export declare function createMonitoringSystem(db: Database.Database, config?: MonitoringSystemConfig): MonitoringSystem;
