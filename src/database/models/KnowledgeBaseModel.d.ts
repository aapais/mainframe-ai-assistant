...
import { KBEntry, CreateKBEntry, UpdateKBEntry, SearchQuery, SearchResult, SearchWithFacets, EntryFeedback, DatabaseStats } from '../schemas/KnowledgeBase.schema';
...
export declare class KnowledgeBaseModel {
    ...
    constructor(db: Database.Database, performanceMonitor: PerformanceMonitor, queryOptimizer: QueryOptimizer);
