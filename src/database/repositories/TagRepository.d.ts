...
import { Tag, CreateTag, UpdateTag, TagAssociation, BulkTagOperation, BulkOperationResult, TagAnalytics } from '../schemas/HierarchicalCategories.schema';
...
export declare class TagRepository {
    ...
    associateWithEntry(entryId: string, tagId: string, options?: TagAssociationOptions, userId?: string): Promise<void>;
    ...
    getTrending(days?: number, limit?: number): Promise<(Tag & {
        recent_usage: number;
    })[]>;
    cleanup(): void;
}
